...
matched_pop_trim <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, all_confounder_names])
make_matched_correlation_plot(matched_pop_trim, all_confounder_names)
get_gps_matched_logistic_results(matched_pop_trim)
get_gps_matched_semiparametric_results(matched_pop_trim)
get_gps_matched_nonparametric_results(matched_pop_trim)
```
...
matched_pop_trim_gps99 <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, all_confounder_names], c(0.01, 0.99))
...
get_gps_matched_logistic_results(matched_pop_trim_gps99)
get_gps_matched_nonparametric_results(matched_pop_trim_gps99)
```
...
matched_pop_exposure_untrimmed <- get_gps_matched_pseudo_pop(y, a, x)
make_matched_correlation_plot(matched_pop_exposure_untrimmed, a, x, all_confounder_names)
get_gps_matched_logistic_results(matched_pop_exposure_untrimmed)
get_gps_matched_nonparametric_results(matched_pop_exposure_untrimmed)
```
...
matched_pop_within_distance <- get_gps_matched_pseudo_pop(y, ceiling_a, x)
make_matched_correlation_plot(matched_pop_within_distance, ceiling_a, x, all_confounder_names)
get_gps_matched_logistic_results(matched_pop_within_distance)
get_gps_matched_nonparametric_results(matched_pop_within_distance)
```
...
matched_pop_discretized_treatment <- get_gps_matched_pseudo_pop(y, data_discretized$a, x)
make_matched_correlation_plot(matched_pop_discretized_treatment, data_discretized$a, x, all_confounder_names)
get_gps_matched_logistic_results(matched_pop_discretized_treatment)
```
...
matched_pop_discretized_treatment <- get_gps_matched_pseudo_pop(data_discretized_trim$y, data_discretized_trim$a, data_discretized_trim[, all_confounder_names])
...
matched_pop_without_crime2021 <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, confounders_without_crime2021])
...
get_gps_matched_logistic_results(matched_pop_without_crime2021)
get_gps_matched_nonparametric_results(matched_pop_without_crime2021)
```
...
matched_pop_without_dealers <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, confounders_without_dealers])
...
get_gps_matched_logistic_results(matched_pop_without_dealers)
get_gps_matched_nonparametric_results(matched_pop_without_dealers)
```
...
matched_pop_without_race <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, confounders_without_race])
...
get_gps_matched_logistic_results(matched_pop_without_race)
get_gps_matched_nonparametric_results(matched_pop_without_race)
```
...
matched_exclude_small_tracts <- get_gps_matched_pseudo_pop(data_exclude_small_tracts$y, data_exclude_small_tracts$a, data_exclude_small_tracts[, all_confounder_names])
...
get_gps_matched_logistic_results(matched_exclude_small_tracts)
# get_gps_matched_nonparametric_results(matched_exclude_small_tracts)
```
...
matched_include_grocery_pharmacy_trimmed <- get_gps_matched_pseudo_pop(data_include_grocery_pharmacy_trimmed$y, data_include_grocery_pharmacy_trimmed$a, data_include_grocery_pharmacy_trimmed[, confounders_include_grocery_pharmacy])
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy_trimmed)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy_trimmed)
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy_trimmed_wins99)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy_trimmed_wins99)
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy_trimmed_wins95)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy_trimmed_wins95)
```
...
# GPS-matching causal inference
matched_include_grocery_pharmacy <- get_gps_matched_pseudo_pop(data_include_grocery_pharmacy$y, data_include_grocery_pharmacy$a, data_include_grocery_pharmacy[, confounders_include_grocery_pharmacy])
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy)
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy_wins99)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy_wins99)
...
get_gps_matched_logistic_results(matched_include_grocery_pharmacy_wins95)
get_gps_matched_nonparametric_results(matched_include_grocery_pharmacy_wins95)
```
...
matched_pop_grocery_trimmed <- get_gps_matched_pseudo_pop(data_analysis_grocery$y, data_analysis_grocery$a, data_analysis_grocery[, c(all_confounder_names, "mean_total_km", "mean_pharmacy_km")])
...
get_gps_matched_logistic_results(matched_pop_grocery_trimmed)
get_gps_matched_semiparametric_results(matched_pop_grocery_trimmed)
get_gps_matched_nonparametric_results(matched_pop_grocery_trimmed)
```
...
get_gps_matched_logistic_results(matched_pop_grocery_trimmed_wins99)
get_gps_matched_nonparametric_results(matched_pop_grocery_trimmed_wins99)
...
get_gps_matched_logistic_results(matched_pop_grocery_trimmed_wins95)
get_gps_matched_nonparametric_results(matched_pop_grocery_trimmed_wins95)
```
...
matched_pop_trim_pharmacy <- get_gps_matched_pseudo_pop(data_analysis_trim_pharmacy$y, data_analysis_trim_pharmacy$a, data_analysis_trim_pharmacy[, c(all_confounder_names, "mean_total_km", "mean_grocery_km")])
...
get_gps_matched_logistic_results(matched_pop_trim_pharmacy)
get_gps_matched_semiparametric_results(matched_pop_trim_pharmacy)
get_gps_matched_nonparametric_results(matched_pop_trim_pharmacy)
```
...
get_gps_matched_logistic_results(matched_pop_pharmacy_trimmed_wins99)
get_gps_matched_nonparametric_results(matched_pop_pharmacy_trimmed_wins99)
...
get_gps_matched_logistic_results(matched_pop_pharmacy_trimmed_wins95)
get_gps_matched_nonparametric_results(matched_pop_pharmacy_trimmed_wins95)
```
...
matched_pop_grocery_quartiled_trimmed <- get_gps_matched_pseudo_pop(data_analysis_grocery_quartiled$y, data_analysis_grocery_quartiled$a, data_analysis_grocery_quartiled[, c(all_confounder_names, "mean_total_km", "mean_pharmacy_km")])
...
get_gps_matched_logistic_results(matched_pop_grocery_quartiled_trimmed)
get_gps_matched_semiparametric_results(matched_pop_grocery_quartiled_trimmed)
get_gps_matched_nonparametric_results(matched_pop_grocery_quartiled_trimmed)
```
...
get_gps_matched_logistic_results(matched_pop_grocery_quartiled_trimmed_wins99)
get_gps_matched_nonparametric_results(matched_pop_grocery_quartiled_trimmed_wins99)
...
get_gps_matched_logistic_results(matched_pop_grocery_quartiled_trimmed_wins95)
get_gps_matched_nonparametric_results(matched_pop_grocery_quartiled_trimmed_wins95)
```
...
matched_pop_trim_pharmacy_quartiled <- get_gps_matched_pseudo_pop(data_analysis_trim_pharmacy_quartiled$y, data_analysis_trim_pharmacy_quartiled$a, data_analysis_trim_pharmacy_quartiled[, c(all_confounder_names, "mean_total_km", "mean_grocery_km")])
...
get_gps_matched_logistic_results(matched_pop_trim_pharmacy_quartiled)
get_gps_matched_semiparametric_results(matched_pop_trim_pharmacy_quartiled)
get_gps_matched_nonparametric_results(matched_pop_trim_pharmacy_quartiled)
```
...
get_gps_matched_logistic_results(matched_pop_pharmacy_quartiled_trimmed_wins99)
get_gps_matched_nonparametric_results(matched_pop_pharmacy_quartiled_trimmed_wins99)
...
get_gps_matched_logistic_results(matched_pop_pharmacy_quartiled_trimmed_wins95)
get_gps_matched_nonparametric_results(matched_pop_pharmacy_quartiled_trimmed_wins95)
```
...
matched_without_top_ten_matches <- get_gps_matched_pseudo_pop(data_analysis_trim_without_top_ten_matches$y, data_analysis_trim_without_top_ten_matches$a, data_analysis_trim_without_top_ten_matches[, all_confounder_names])
...
get_gps_matched_logistic_results(matched_without_top_ten_matches)
get_gps_matched_semiparametric_results(matched_without_top_ten_matches)
get_gps_matched_nonparametric_results(matched_without_top_ten_matches)
```
...
matched_pop_trim_seed2 <- get_gps_matched_pseudo_pop(data_analysis_trim_exposure$y, data_analysis_trim_exposure$a, data_analysis_trim_exposure[, all_confounder_names])
...
get_gps_matched_logistic_results(matched_pop_trim_seed2)
get_gps_matched_nonparametric_results(matched_pop_trim_seed2)
```
...
matched_pop_dealers_below_median <- get_gps_matched_pseudo_pop(data_dealers_below_median$y, data_dealers_below_median$a, data_dealers_below_median[, all_confounder_names])
...
get_gps_matched_logistic_results(matched_pop_dealers_below_median)
get_gps_matched_nonparametric_results(matched_pop_dealers_below_median)
```
...
matched_pop_dealers_above_median <- get_gps_matched_pseudo_pop(data_dealers_above_median$y, data_dealers_above_median$a, data_dealers_above_median[, all_confounder_names])
...
get_gps_matched_logistic_results(matched_pop_dealers_above_median)
get_gps_matched_nonparametric_results(matched_pop_dealers_above_median)
```
